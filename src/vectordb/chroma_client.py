...
class ChromaClient:
    ...
    def add_documents(self, 
        ...
        try:
            ...
            raise VectorDBError(f"Could not add documents: {e}")
    ...
    def search(self,
        ...
        try:
            ...
            raise VectorDBError(f"Could not perform search: {e}")
    ...
    def get_by_ids(self, ids: List[str]) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise VectorDBError(f"Could not retrieve documents: {e}")
    ...
    def delete_documents(self, ids: List[str]) -> int:
        ...
        try:
            ...
            raise VectorDBError(f"Could not delete documents: {e}")
