...
class QAInterface:
    ...
    def _handle_analysis_query(self, query: str, intent: Dict[str, Any], response: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _handle_comparison_query(self, query: str, intent: Dict[str, Any], response: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _handle_general_query(self, query: str, intent: Dict[str, Any], response: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        if self.llm_client:
            ...
            # Fallback response
            response['content'] = """I understand you're asking about the call data. 
            While I can't provide a specific answer without LLM support, I can help you with:
