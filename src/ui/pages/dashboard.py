...
class DashboardPage:
    ...
    def render(self) -> None:
        ...
        try:
            ...
            st.markdown("Real-time insights and performance metrics for your call center operations")
            ...
            if data.empty:
                st.warning("No data available for the selected period. Please adjust your filters or upload call data.")
    ...
    def _render_recent_calls_section(self, data: pd.DataFrame) -> None:
        ...
        recent_calls = data.nlargest(10, 'timestamp') if 'timestamp' in data.columns else data.head(10)
